...
import { CalendarDays, Clock, XCircle,BadgeAlert  } from "lucide-react"; // <-- added AlertTriangle
...
export default function BookingCard({
  ...
  return (
   <div
  className={`relative bg-white rounded-2xl shadow-md p-4 border-l-4 ${
    highlighted
      ? "border-l-green-600"
      : status === "scheduled"
      ? "border-l-green-600"
...
>
      ...
      <div className="mt-4 relative">
        ...
        >
          ...
          {/* Only show arrow for “Accept and Pay Advance” */}
          {isAcceptButton && (
