...
export default function CongratulationsPass() {
  return (
    <div className="min-h-screen bg-[#1C1C2E] flex items-center justify-center p-4">
      {/* Card */}
      <div className="bg-white rounded-2xl w-full max-w-lg max-h-lg py-25 flex flex-col items-center text-center relative">
        {/* Avatar */}
        
          {/* Placeholder for image */}
          <img
            src="/congratslogo.png"
            alt="Avatar"
