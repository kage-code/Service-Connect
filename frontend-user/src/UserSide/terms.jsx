...
export default function Terms() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      {/* Header */}
      <CommonHeader title="TERMS & CONDITIONS" onBack={() => navigate(-1)} />

      {/* Content */}
      <div className="flex-1 overflow-y-auto px-6 py-4">
        <section className="space-y-5 text-gray-900 mx-2 mt-10">
          <div >
            <h2 className="text-base font-semibold mb-2 ">Condition & Attending</h2>
          ...
          <div>
            <h2 className="text-base font-semibold mb-2">Terms & Use</h2>
            <p className="text-sm leading-relaxed text-gray-700">
